...
void EnemySoldier::CreateAttackCollsion()
{
	...
	attack->Create(_MyComponent.Parameter->GiveDamageMass(false, false), Vector3(0.0f, 0.0f, 1.0f), Quaternion::Identity, Vector3(1.0f, 2.0f, 1.0f), AttackCollision::CollisionMaster::Enemy, 0.15f, AttackCollision::ReactionType::Leans, transform);
	attack->RemoveParent();

...
void EnemyGolem::_BuildAnimation() 
{
	...
	{
		// 待機状態。
		_ConfigAnimationType(EnemyCharacter::AnimationType::Idle, *Datas[static_cast<int>(EnemyGolemAnim::Stand)].get());
		// 歩行状態。
		_ConfigAnimationType(EnemyCharacter::AnimationType::Walk, *Datas[static_cast<int>(EnemyGolemAnim::Walk)].get());
		// 走行状態。
		_ConfigAnimationType(EnemyCharacter::AnimationType::Dash, *Datas[static_cast<int>(EnemyGolemAnim::Run)].get());
		// 攻撃状態。
		_ConfigAnimationType(EnemyCharacter::AnimationType::Attack1, *Datas[static_cast<int>(EnemyGolemAnim::Attack01)].get());
		// 落下状態。
		_ConfigAnimationType(EnemyCharacter::AnimationType::Fall, *Datas[static_cast<int>(EnemyGolemAnim::Fall)].get());
		// ダメージ状態。
		_ConfigAnimationType(EnemyCharacter::AnimationType::Damage, *Datas[static_cast<int>(EnemyGolemAnim::Damage)].get());
		// 死亡状態。
		_ConfigAnimationType(EnemyCharacter::AnimationType::Death, *Datas[static_cast<int>(EnemyGolemAnim::Death)].get());
	}
}
